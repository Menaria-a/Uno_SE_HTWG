...
final class u1$u002Eworksheet$_ {
def args = u1$u002Eworksheet_sc.args$
def scriptPath = """scala/u1.worksheet.sc"""
/*<script>*/
...
object u1$u002Eworksheet_sc {
  ...
  lazy val script = new u1$u002Eworksheet$_
...
export u1$u002Eworksheet_sc.script as `u1.worksheet`
